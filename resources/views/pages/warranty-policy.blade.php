<x-public-layout>
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white border border-slate-200 rounded-lg p-6 sm:p-8 space-y-5 text-sm text-slate-700 leading-relaxed">
            ...
            <div class="rounded-md bg-amber-50 border border-amber-200 px-4 py-3 text-amber-950">
            ...
            <p>
                ...
                Application form and upload clear photos of the VIN plate and odometer.
            </p>
            <ul class="list-disc ps-5 space-y-2">
                <li>Provide accurate company, truck, and part details.</li>
